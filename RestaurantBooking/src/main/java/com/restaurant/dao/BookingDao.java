...
public class BookingDao {
    ...
    /**
     * Create a booking row from a waitlist entry. Called when staff presses "Notify".
     */
    public void createBookingFromWaitlist(int waitlistId) throws SQLException {
        ...
        try (Connection conn = getConn();
            ...
            try (ResultSet rs = psSel.executeQuery()) {
                ...
                String notes = (specialReqs == null || specialReqs.isBlank())
                        ? "From waitlist: " + customer
                        : specialReqs;
    ...
    public List<Booking> findBookingsForRestaurant(int restaurantId) throws SQLException {
        String sql = """
            SELECT b.*,
                   u.email      AS customer_email,
                   u.first_name AS customer_first_name,
