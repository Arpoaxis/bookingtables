...
<div class="navigation">
	<c:choose>
		<c:when test="${sessionScope.user != null and sessionScope.user.accountType eq 'ADMIN'}">
            <a href="${pageContext.request.contextPath}/jsp/admin/dashboard.jsp">Home</a>
        </c:when>
		<c:when test="${sessionScope.user != null and sessionScope.user.accountType eq 'CUSTOMER'}">
