...
<div class="app-header">
	...
	<%-- Center: Search bar (customers / public only) --%>
	<c:if
		test="${empty sessionScope.role 
                 || fn:toUpperCase(sessionScope.role) == 'CUSTOMER'}">
					...
					<c:when test="${not empty sessionScope.user}">
						<div class="profile-menu-header">
							<strong>${sessionScope.user.firstName}
								${sessionScope.user.lastName}</strong>
						...
						<c:if
							test="${sessionScope.role == 'ADMIN' || sessionScope.role == 'MANAGER'}">
